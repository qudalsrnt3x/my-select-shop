...
class ProductServiceIntegrationTest {
    ...
    void test3() {
        ...
        searchParameter.setPage(0);
        searchParameter.setSize(10);
        searchParameter.setSortBy("id");
        searchParameter.setIsAsc(false);

        // when
        Page<ProductResponseDto> productList = productService.getProducts(user, searchParameter);
