...
import com.sparta.myselectshop.controller.ProductApiController;
...
@WebMvcTest(
        controllers = {UserController.class, ProductApiController.class},
        excludeFilters = {
...
class UserProductMvcTest {
    ...
    public void setup() {
        mvc = MockMvcBuilders.webAppContextSetup(context)
                .apply(springSecurity(new MockSpringSecurityFilter())) // 테스트를 위한 시큐리티필터를 주입해 준다.
                .build();
    }
