...
public class UseTimeAop {
    ...
    @Pointcut("execution(* com.sparta.myselectshop.controller.ProductApiController.*(..))")
    private void product() {}
    @Pointcut("execution(* com.sparta.myselectshop.controller.FolderApiController.*(..))")
    private void folder() {}
